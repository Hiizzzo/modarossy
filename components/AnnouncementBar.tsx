...
export default function AnnouncementBar() {
  ...
  if (isDev) {
    return (
      <div className="fixed inset-x-0 bottom-0 z-30 flex items-center justify-center bg-celeste-500 py-6 text-white">
        {!onNuevo && (
          <a
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-30 overflow-hidden bg-celeste-500 text-white">
      <div className="announcement-track flex w-max gap-16 whitespace-nowrap py-6 text-lg font-bold uppercase tracking-[0.2em]">
        {loop.map((t, i) => (
